...
function () {
  ...
  ApiSync.prototype.fetch = function (id) {
    var promise = axios_1.default.get("".concat(this.rootUrl, "/").concat(id));
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // get(propName: string): number|string|boolean{
  ...
  Attributes.prototype.set = function (updateData) {
...
function () {
  function Eventing() {
    var _this = this; //events是个object，key是string，value是CallBack array


    this.events = {}; //register the function in events
...
function () {
  ...
  Model.prototype.set = function (updateData) {
...
exports.Model = Model;
},{}],"src/models/ModelCollection.ts":[function(require,module,exports) {
"use strict";
...
var Eventing_1 = require("./Eventing"); //k代表fetch的json data


var ModelCollection =
/** @class */
function () {
  function ModelCollection(rootUrl, deserialize //将json数据转化成Object
  ) {
    this.rootUrl = rootUrl;
  ...
  Object.defineProperty(ModelCollection.prototype, "on", {
    get: function get() {
      return this.events.on;
    },
    enumerable: false,
  ...
  Object.defineProperty(ModelCollection.prototype, "trigger", {
    get: function get() {
      return this.events.trigger;
    },
    enumerable: false,
...
exports.ModelCollection = ModelCollection; // const userCollection = new ModelCollection<User,UserProps>(
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new ModelCollection_1.ModelCollection(rootUrl, function (data) {
...
exports.User = User;
},{"./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts","./ModelCollection":"src/models/ModelCollection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function mapRegions(fragment) {
      var regionsMap = this.regionsMap(); //遍历需要创建的region
    ...
    value: function render() {
      //先清零
      this.parent.innerHTML = ''; //用template把string转成html

      var templateElement = document.createElement('template');
      templateElement.innerHTML = this.template();
      this.bindEvents(templateElement.content);
      this.mapRegions(templateElement.content); //nest UserForm and UserShow in UserEdit

      this.onRender(); //把template的html加到parent html element中
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.onSetAgeClick = function () {
      _this.model.setRandomAge(); // this.render();  不可行，会增加多余的UserForm
...
if (element) {
  var userEdit = new UserEdit_1.UserEdit(element, user);
  userEdit.render();
  console.log(userEdit.regions);
} else {
  throw new Error('root element not found!');
}
},{"./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
